...
#include "ExhaustivePlacementPatternFinder.h"
#include <algorithm>
#include <fstream>
#include <iostream>
#include <stdexcept>
...
void findPlacementPatternExhaustiveTest(
    const std::string &lineStr, const std::vector<int> &hintNumbers,
  ...
  std::vector<Placement> result =
      ExhaustivePlacementPatternFinder::run(line, hintSet);
...
TEST(Algorithm_FindPlacementPatternExhaustive, VerySimpleCase) {
  findPlacementPatternExhaustiveTest("      ", {3},
                                     {
                                         "BBBWWW",
                                         "WBBBWW",
                                         "WWBBBW",
...
TEST(Algorithm_FindPlacementPatternExhaustive, ConditionedVerySimpleCase) {
  findPlacementPatternExhaustiveTest(" B    ", {3},
                                     {
                                         "BBBWWW",
                                         "WBBBWW",
                                     });
...
TEST(Algorithm_FindPlacementPatternExhaustive, SomeHintsCase) {
  findPlacementPatternExhaustiveTest("      ", {1, 3},
                                     {
                                         "BWBBBW",
                                         "BWWBBB",
                                         "WBWBBB",
...
TEST(Algorithm_FindPlacementPatternExhaustive, ConditionedSomeHintsCase) {
  findPlacementPatternExhaustiveTest(" B    ", {1, 3},
                                     {
                                         "WBWBBB",
                                     });
}
...
TEST(Algorithm_FindPlacementPatternExhaustive, ManyHintsCase) {
  const std::string fileName =
      "Algorithm_FindPlacementPatternExhaustive_ManyHintsCase.txt";
