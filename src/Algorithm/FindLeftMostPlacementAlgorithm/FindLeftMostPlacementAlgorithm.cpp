...
Placement FindLeftMostPlacementAlgorithm::run(const Line &line,
                                              const HintSet &hintSet) {
  return getLeftMostPlacement(line, hintSet);
}

Placement
FindLeftMostPlacementAlgorithm::getLeftMostPlacement(const Line &line,
                                                     const HintSet &hintSet) {
...
Placement FindLeftMostPlacementAlgorithm::getLeftMostPlacementRecursive(
    const Line &line, const HintSet &hintSet, Placement &currentPlacement,
