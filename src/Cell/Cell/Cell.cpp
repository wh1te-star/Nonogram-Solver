...
Cell::Cell(CellColor color) : color(std::move(color)) {}

const CellColor &Cell::getColor() const { return color; }

bool Cell::operator==(const Cell &other) const { return color == other.color; }
