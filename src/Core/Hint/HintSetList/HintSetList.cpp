...
HintSetList::HintSetList(std::vector<HintSet> hintSetList) : hintSetList(hintSetList) {}
...
bool HintSetList::operator!=(const HintSetList &other) const { return !(*this == other); }
