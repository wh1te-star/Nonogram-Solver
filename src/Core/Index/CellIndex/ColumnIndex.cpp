...
ColumnIndex ColumnIndex::operator+(int shift) const { return ColumnIndex(index + shift); }
...
bool ColumnIndex::operator==(const ColumnIndex &other) const { return index == other.index; }
...
bool ColumnIndex::operator>=(const ColumnIndex &other) const { return index >= other.index; }
bool ColumnIndex::operator<(const ColumnLength &other) const { return index < other.getLength(); }
