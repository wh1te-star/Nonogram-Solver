...
int CellIndex::getIndex() const { return index; }

CellIndexType CellIndex::getType() const { return type; }
...
CellIndex CellIndex::operator+(int shift) const { return CellIndex(index + shift); }
...
bool CellIndex::operator==(const CellIndex &other) const { return index == other.index; }
...
bool CellIndex::operator>=(const CellIndex &other) const { return index >= other.index; }
bool CellIndex::operator<(const BoardLength &other) const { return index < other.getLength(); }
