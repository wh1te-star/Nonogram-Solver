...
RowIndex RowIndex::operator+(int shift) const { return RowIndex(index + shift); }

RowIndex RowIndex::operator-(int shift) const { return RowIndex(index - shift); }

RowIndex RowIndex::operator+(RowLength shift) const { return RowIndex(index + shift.getLength()); }

RowIndex RowIndex::operator-(RowLength shift) const { return RowIndex(index - shift.getLength()); }

RowIndex RowIndex::operator+(HintNumber shift) const { return RowIndex(index + shift.getNumber()); }

RowIndex RowIndex::operator-(HintNumber shift) const { return RowIndex(index - shift.getNumber()); }

bool RowIndex::operator==(const RowIndex &other) const { return index == other.index; }
...
bool RowIndex::operator>=(const RowIndex &other) const { return index >= other.index; }
bool RowIndex::operator<(const RowLength &other) const { return index < other.getLength(); }
